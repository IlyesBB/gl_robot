...
The feed parser implements an gui for incrementally parsing an email
message, line by line.  This has advantages for certain applications, such as
those reading email messages off a socket.

FeedParser.feed() is the primary gui for pushing new data into the
...
class FeedParser(object):
    ...
    # Non-public gui for supporting Parser's headersonly flag
